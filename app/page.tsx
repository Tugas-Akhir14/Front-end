          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16 space-y-4">
              <div className="inline-block">
                <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-500 mb-4">
                  Vision & Mission
                </h2>
            ...
            {loadingVm ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {[0, 1, 2].map((i) => (
                  <Card key={i} className="bg-gradient-to-br from-amber-950 to-yellow-950 border-2 border-amber-700 animate-pulse overflow-hidden">
                    <div className="h-40 bg-gradient-to-br from-amber-800 to-yellow-800" />
                    <CardContent className="p-6 space-y-3">
                      <div className="h-6 bg-amber-800 rounded-lg w-3/4" />
                      <div className="h-4 bg-amber-800 rounded-lg w-2/3" />
                      <div className="h-4 bg-amber-800 rounded-lg w-1/2" />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="text-center py-12">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-900/50 border-2 border-red-700 mb-4">
                  <span className="text-2xl text-red-400">⚠️</span>
                </div>
                <p className="text-gray-300">{vmError}</p>
              </div>
            ) : !vm ? (
              <div className="text-center py-12">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-amber-900/50 border-2 border-amber-700 mb-4">
                  <span className="text-2xl text-amber-400">📄</span>
                </div>
                <p className="text-gray-300">Visi & misi belum diatur.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Vision Card */}
                <Card className="lg:col-span-1 overflow-hidden border-2 border-amber-600 bg-gradient-to-br from-gray-900 via-amber-950/50 to-yellow-950/50 hover:border-amber-500 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 group relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-800/0 via-amber-800/0 to-amber-800/0 group-hover:from-amber-800/20 group-hover:via-yellow-800/10 group-hover:to-amber-800/20 transition-all duration-500" />
                  
                  <div className="relative h-40 bg-gradient-to-br from-amber-700/30 via-yellow-700/20 to-amber-800/30 flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" />
                  </div>
                ...
                {/* Missions Card */}
                <Card className="lg:col-span-2 overflow-hidden border-2 border-amber-600 bg-gradient-to-br from-gray-900 via-amber-950/50 to-yellow-950/50 hover:border-amber-500 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 group relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-800/0 via-amber-800/0 to-amber-800/0 group-hover:from-amber-800/20 group-hover:via-yellow-800/10 group-hover:to-amber-800/20 transition-all duration-500" />
                    ...
                    {vm.missions?.length ? (
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {vm.missions.map((m, idx) => (
                          <li 
                            key={idx} 
                            className="group/item relative pl-6 text-gray-300 hover:text-amber-300 transition-colors duration-300"
                          >
                            ...
                            <div className="relative p-3 rounded-lg bg-gradient-to-br from-transparent to-transparent group-hover/item:from-amber-900/30 group-hover/item:to-yellow-900/30 transition-all duration-300 border border-transparent group-hover/item:border-amber-700">
                      ...
                      <div className="text-center py-8">
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-amber-900/50 border-2 border-amber-700 mb-3">
                          <span className="text-xl text-amber-400">📝</span>
                        </div>
                        <p className="text-gray-300">Belum ada daftar misi.</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
...
<section className="py-24 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="text-center mb-20">
      <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-amber-900/50 to-yellow-900/50 border-2 border-amber-600 rounded-full px-6 py-2 mb-6 backdrop-blur-sm">
    ...
    {loadingRooms ? (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[...Array(3)].map((_, i) => (
          <Card key={i} className="overflow-hidden bg-gradient-to-br from-gray-900 to-amber-950 border-2 border-amber-700 animate-pulse">
            <div className="h-72 bg-gradient-to-br from-amber-800 to-yellow-800 relative">
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>
            </div>
            <CardContent className="p-8 space-y-4">
              <div className="h-7 bg-gradient-to-r from-amber-800 to-yellow-800 rounded-lg w-3/4" />
              <div className="h-5 bg-gradient-to-r from-amber-800 to-yellow-800 rounded w-1/2" />
              <div className="space-y-3 py-4">
                {[...Array(4)].map((_, j) => (
                  <div key={j} className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-amber-600 rounded-full" />
                    <div className="h-4 bg-gradient-to-r from-amber-800 to-yellow-800 rounded flex-1" />
                  </div>
                ))}
              </div>
              <div className="h-12 bg-gradient-to-r from-amber-800 to-yellow-800 rounded-lg mt-6" />
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="text-center py-20">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-red-900/50 border-2 border-red-700 rounded-full mb-4">
      ...
      <div className="text-center py-20">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-amber-900/50 border-2 border-amber-700 rounded-full mb-6">
          <svg className="w-10 h-10 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
        </div>
        <p className="text-gray-300 text-xl">No rooms available at the moment</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {rooms.map((room, index) => (
          <Card
            key={room.id}
            className="overflow-hidden hover:shadow-2xl hover:shadow-amber-500/30 transition-all duration-500 border-2 border-amber-700 bg-gray-900 hover:border-amber-500 hover:transform hover:-translate-y-3 group"
          ...
          >
            <div className="relative h-72 overflow-hidden">
              {room.image ? (
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      ...
                      fallback.className =
                        'w-full h-full bg-gradient-to-br from-amber-800 via-yellow-800 to-amber-900 flex items-center justify-center';
                      fallback.innerHTML = `
                ...
                <div className="w-full h-full bg-gradient-to-br from-amber-800 via-yellow-800 to-amber-900 flex items-center justify-center">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-amber-950/40 to-transparent opacity-60"></div>
              ...
              <div className="absolute top-4 left-4 bg-black/90 backdrop-blur-sm text-amber-300 px-4 py-2 rounded-lg text-sm font-bold shadow-lg border-2 border-amber-600">
                Room {room.number}
              </div>
            ...
            <CardContent className="p-8 bg-gradient-to-br from-gray-900 to-amber-950/30">
              <h3 className="text-2xl font-bold text-transparent bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text mb-6">
                {formatTypeName(room.type)}
              </h3>
              
              <div className="space-y-3 mb-8">
                {getFeatures(room).map((f, i) => (
                  <div key={i} className="flex items-center text-gray-300 group/item hover:text-amber-400 transition-colors">
