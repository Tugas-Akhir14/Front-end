                ...
                <div className="space-y-2">
                  ...
                  <Select value={role} onValueChange={(v) => setRole(v as any)}>
                    ...
                    <SelectContent className="rounded-xl border-amber-200">
                       <SelectItem value="admin_hotel" className="rounded-lg">
                        <div className="flex items-center gap-2">
                          <User className="w-4 h-4 text-amber-500" />
                          Admin Hotel
                        </div>
                      </SelectItem>
                       <SelectItem value="admin_souvenir" className="rounded-lg">
                        <div className="flex items-center gap-2">
                          <User className="w-4 h-4 text-amber-500" />
                          Admin Souvenir
                        </div>
                      </SelectItem>
                       <SelectItem value="admin_buku" className="rounded-lg">
                        <div className="flex items-center gap-2">
                          <User className="w-4 h-4 text-amber-500" />
                          Admin Buku
                        </div>
                      </SelectItem>
                          <SelectItem value="admin_cafe" className="rounded-lg">
                        <div className="flex items-center gap-2">
                          <User className="w-4 h-4 text-amber-500" />
                          Admin Cafe
                        </div>
