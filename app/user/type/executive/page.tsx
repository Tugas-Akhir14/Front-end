...
import { ChevronLeft, Maximize, Users, Bed, Wifi, Briefcase, Car, Coffee, Tv, Wine, Bath, Newspaper } from "lucide-react";
...
export default function ExecutiveSuiteDetail() {
  ...
  const amenities = [
    { icon: Coffee, label: "Executive Lounge Access" },
    { icon: Car, label: "Priority Check-in" },
    { icon: Wifi, label: "Gigabit Wi-Fi + VPN" },
    { icon: Tv, label: "75” OLED Smart TV" },
    { icon: Wine, label: "Premium Minibar" },
    { icon: Bath, label: "Deep Soaking Tub" },
    { icon: Newspaper, label: "Daily Newspaper" },
    { icon: Briefcase, label: "Private Work Desk" },
  ];
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center px-6 animate-fade-in-up">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6">
              Executive <span style={{ color: GOLD }}>Suite</span>
            </h1>
            <p className="text-xl text-gray-200 font-light max-w-2xl mx-auto tracking-wide">
              Power and privacy combined. Exclusive access, separate living areas, and premium services.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed text-lg font-light">
                Tailored for decision-makers, the Executive Suite offers 68 m² of sophisticated living space.
                Enjoy a separate living area perfect for private meetings or relaxation. Guests receive exclusive
                access to the Executive Lounge, priority services, and premium amenities designed for maximum productivity and comfort.
              </p>
            </div>
              ...
              <Card className="bg-gray-900 border-gray-800 p-8 rounded-3xl shadow-2xl shadow-black/50 overflow-hidden relative">
                ...
                <div className="relative z-10 text-center space-y-8">
                  <div>
                    ...
                    <p className="text-teal-400 text-sm font-medium">Includes Executive Lounge Access</p>
                  </div>
                  ...
                  <div className="pt-6 border-t border-gray-800 text-xs text-center text-gray-500 space-y-1">
                    <p>Late Checkout upon availability</p>
